...
### 🔄 变更
- 将内置 Mermaid runtime 更新到 [mermaid@11.17.1](https://github.com/mermaid-js/mermaid/releases/tag/mermaid%4011.17.1)。
...
### 📚 文档
- 新增中英文 FAQ，说明 JetBrains IDE 2026.2+ 内置官方 Mermaid 插件后可能产生的预览冲突，并补充报错截图及逐步禁用插件的操作说明。
...
### 🔄 变更
- 将内置 Mermaid runtime 更新到 [mermaid@11.16.0](https://github.com/mermaid-js/mermaid/releases/tag/mermaid%4011.16.0)。
## [1.2.0]
...
### 🔧 CI/CD
- 修复 release 准备流程，归档 Unreleased changelog 条目后会从 Unreleased 区块移除原内容。
